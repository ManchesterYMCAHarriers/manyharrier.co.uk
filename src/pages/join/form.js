                      ...
                      >
                          ...
                          statements={
                            <dl>
                              ...
                              <dd>
                                ...
                                Club
                                are not permitted to accept items for
                                safe-keeping,
                                regardless of whether I am a member of the Y
                                Club or
                                not.
                              </dd>
                              {this.state.data.yClubMembership === 'Non-member' && (
                                <dd>
                                  ...
                                  Club,
                                  I should arrive at sessions starting from the
                                  Y Club
                                  "ready to run".
                                </dd>
                              )}
                              ...
                              {this.state.data.membership === firstClaimSku && (
                                <dd>
                                  ...
                                  first
                                  claim member of the Manchester YMCA Harriers
                                  Club
                              ...
                              <dd>
                                ...
                                Club is a
                                registered club in the disciplines of road
                                running,
                                fell running, cross country running and trail
                                running.
                              </dd>
                              {this.state.data.membership === firstClaimSku && (
                                <dd>
                                  ...
                                  competitions
                                  in these disciplines, I am expected to
                                  represent the
                                  Manchester YMCA Harriers Club in that
                                  competition.
                                </dd>
                              )}
                              {this.state.data.membership === secondClaimSku && (
                                <dd>
                                  ...
                                  the
                                  Manchester YMCA Harriers Club if my first
                                  claim club
                              ...
                              <dd>
                                ...
                                personal data can be processed by any member of
                                the
                              ...
                              {this.state.data.membership === firstClaimSku && (
                                <dd>
                                  ...
                                  automatically
                                  be registered as a member of England
                                  Athletics. The
                                  Club will provide England Athletics with your
                                  personal data which they will use to enable
                                  access
                                  ...
                                  amongst
                                  other things, set and amend your privacy
                                  settings.
                        ...
                        >
                          <dl>
                            ...
                            <dt>Manchester YMCA Harriers Club membership type
                            </dt>
                            <dd>
                              {this.state.data.membership === firstClaimSku
                                ? 'First claim membership @ ' +
