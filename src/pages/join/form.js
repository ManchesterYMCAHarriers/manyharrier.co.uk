                    ...
                    statements={
                      <dl>
                        ...
                        <dd>
                          ...
                          Harriers Club and I agree to abide by the{' '}
                        ...
                        <dd>
                          ...
                          and the Y Club are separate entities.
                        </dd>
                        <dd>
                        ...
                        <dd>
                          ...
                          are not permitted to accept items for safe-keeping,
                          regardless of whether I am a member of the Y Club or
                          not.
                        </dd>
                        {this.state.data.yClubMembership === 'Non-member' && (
                          <dd>
                            I am aware that as I am not a member of the Y Club,
                            I should arrive at sessions starting from the Y Club
                            "ready to run".
                          </dd>
                        )}
                        {this.state.data.yClubMembership === 'Non-member' && (
                        ...
                        <dd>
                          I am aware that the Manchester YMCA Harriers Club is a
                          registered club in the disciplines of road running,
                          fell running, cross country running and trail running.
                        </dd>
                        {this.state.data.membership === firstClaimSku && (
                          <dd>
                        ...
                        {this.state.data.membership === secondClaimSku && (
                          <dd>
                            ...
                            competitions, I will only be able to represent the
                            Manchester YMCA Harriers Club if my first claim club
                        ...
                        <dd>
                          I understand that my personal data will be controlled
                          by the Manchester YMCA Harriers Club and that my
                          personal data can be processed by any member of the
                          Club's Committee for official Club business.
                        </dd>
                        {this.state.data.membership === firstClaimSku && (
                          <dd>
                            I understand that on becoming a member of the
                            Manchester YMCA Harriers Club I will automatically
                            be registered as a member of England Athletics. The
                            Club will provide England Athletics with your
                            personal data which they will use to enable access
                            to an online portal for you (called{' '}
                            ...
                            If you have any questions about the continuing
                            privacy of your personal data when it is shared with
