...
export default class Form extends React.Component {
  ...
  redirectToCheckout = async () => {
    return await this.stripe.redirectToCheckout({
      ...
      successUrl:
        this.state.baseUrl + ((this.state.data.membership === this.state.stripeSkus.firstClaim)
      ...
      <StaticQuery
        ...
        render={({page, firstClaim, secondClaim}) => {
          ...
          const firstClaimPrice =
            '£' + (firstClaim.price / 100).toFixed(2)
          const firstClaimValidTo = firstClaim.attributes.valid_to
          const secondClaimSku = secondClaim.id
          const secondClaimPrice =
            '£' + (secondClaim.price / 100).toFixed(2)
          const secondClaimValidTo =
            firstClaim.attributes.valid_to
                    ...
                    options={[
                      {
                        ...
                        label:
                          "First claim membership @ " + firstClaimPrice + ", valid until " + firstClaimValidTo,
                        value: firstClaimSku,
                      },
                      {
                        id: 'membershipSecondClaim',
                        label:
                          "Second claim membership @ " + secondClaimPrice + ", valid until " + secondClaimValidTo,
