                  ...
                  options={[
                    {
                      ...
                      label:
                        'First claim - £' +
                        this.state.membershipFees['First claim'] +
                        ' - valid until ' +
                        this.state.membershipValidUntil,
                      value: 'First claim',
                    },
                    {
                      ...
                      label:
                        'Second claim - £' +
                        this.state.membershipFees['Second claim'] +
                        ' - valid until ' +
                        this.state.membershipValidUntil,
                      value: 'Second claim',
                    },
                ...
                >
                  <dl>
                    ...
                    <dd>
                      ...
                      valid until {this.state.membershipValidUntil}
                    </dd>
                    {this.state.data.membership === 'Second claim' && (
                    ...
                    <dd>
                      You have opted
                      {this.state.data.newsletter === 'No' && ' not'} to receive
                    ...
                    <dd>
                      You have accepted the rules and Data Protection statements
                    </dd>
