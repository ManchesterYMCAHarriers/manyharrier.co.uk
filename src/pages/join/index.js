            ...
            <div className="container">
              <div className="content">
                <PageTitle
                  title={'Join us'}
                  subtitle={
                    firstClaimDescription + ' is just ' + firstClaimPrice + '!'
                  }
                />
                <p />
                ...
                <p>
                  ...
                  call on <a href="tel:+441618373535">0161 837 3535</a> and they
                ...
                <p className="has-text-centered">
                  <Link to={'/join/apply'} className="button is-primary">
                    Join us now!
                  </Link>
                </p>

                <p>
                  Of course, if you've got any questions before you come down,
                  don't hesitate to <Link to="/contact">get in touch</Link>!
                </p>
                ...
                <p>
                  Joining a running club - <em>any running club</em> - is a
                ...
                <ul>
                  ...
                  <li>
                    Discounts at various sports shops and England Athletics
                    partners
                  </li>
                </ul>
                ...
                <p>
                  We are based at{' '}
                  <Link to={'/venues/the-y-club'}>the Y Club</Link> on Liverpool
                ...
                />
                <p>
                  We meet at <Link to={'/venues/the-y-club'}>the Y Club</Link>{' '}
                ...
                <p>
                  The Y Club offers a special <strong>Social Membership</strong>{' '}
