    ...
    <section className="section">
      <div className="container">
        <div className="content">
          ...
          <p>As you have joined with second claim membership, you will already
            be registered with England Athletics by your first claim club.</p>
          <p>Remember - you will only be able to represent the Manchester YMCA
            ...
            vest or T-shirt is free of charge!</p>
        </div>
      </div>
    </section>
  </Layout>
