      ...
      <StaticQuery
        query={graphql`
          query SkusForMembership {
            firstClaim: allStripeSku(
              filter: {
                product: {
                  name: { eq: "Manchester YMCA Harriers Club Membership" }
                }
                attributes: { name: { glob: "First*" } }
                active: { eq: true }
              }
            ) {
              edges {
            ...
            secondClaim: allStripeSku(
              filter: {
                product: {
                  name: { eq: "Manchester YMCA Harriers Club Membership" }
                }
                attributes: { name: { glob: "Second*" } }
                active: { eq: true }
              }
            ) {
              edges {
        ...
        render={({ firstClaim, secondClaim }) => {
          ...
          const firstClaimPrice =
            '£' + (firstClaim.edges[0].node.price / 100).toFixed(2)
          const firstClaimDescription = firstClaim.edges[0].node.attributes.name
          const secondClaimSku = secondClaim.edges[0].node.id
          const secondClaimPrice =
            '£' + (secondClaim.edges[0].node.price / 100).toFixed(2)
          const secondClaimDescription =
            firstClaim.edges[0].node.attributes.name
                  ...
                  <div className="content">
                    ...
                    >
                      ...
                      <FieldsetRadios
                        ...
                        hint={
                          'If you wish to use the Y Club facilities, including the changing rooms, lockers, showers and toilets, you must be a member of the Y Club. If you are not a Y Club member, you will need to turn up to group runs "ready to run".'
                        }
                        ...
                        options={[
                          ...
                          },
                          {
                            ...
                            label:
                              'I have off-peak membership of the Y Club gym',
                            value: 'Off-peak member',
                          },
                          {
                            id: 'yClubMembershipStudent',
                            label:
                              'I have student membership of the Y Club gym',
                        ...
                        statements={
                          <dl>
                            ...
                            <dd>
                              ...
                              only available to Y Club members.
                            </dd>
                            <dd>
                              I understand that the reception staff at the Y
                              Club are not permitted to accept items for
                              safe-keeping, regardless of whether I am a member
                              of the Y Club or not.
                            </dd>
                            {this.state.data.yClubMembership ===
                              'Non-member' && (
                              <dd>
                                I am aware that as I am not a member of the Y
                                Club, I should arrive at sessions starting from
                                the Y Club "ready to run".
                              </dd>
                            )}
                            {this.state.data.yClubMembership ===
                              'Non-member' && (
                            ...
                            <dd>
                              I am aware that the Manchester YMCA Harriers Club
                              is a registered club in the disciplines of road
                              running, fell running, cross country running and
                              trail running.
                            </dd>
                            {this.state.data.membership === firstClaimSku && (
                              <dd>
                                I am aware that if I participate in any
                                competitions in these disciplines, I am expected
                                to represent the Manchester YMCA Harriers Club
                                in that competition.
                              </dd>
                            )}
                            {this.state.data.membership === secondClaimSku && (
                              <dd>
                                ...
                                claim club ({this.state.data.firstClaimClub}) is
                                not registered for that discipline.
                              </dd>
                            )}
                            ...
                            <dd>
                              ...
                              and that my personal data can be processed by any
                              member of the Club's Committee for official Club
                              business.
                            </dd>
                            {this.state.data.membership === firstClaimSku && (
                              <dd>
                                ...
                                England Athletics. The Club will provide England
                                Athletics with your personal data which they
                                will use to enable access to an online portal
                                for you (called <em>myAthletics</em>). England
                                Athletics will contact you to invite you to sign
                                into the <em>myAthletics</em> portal, where you
                                can, amongst other things, set and amend your
                      ...
                      >
                        <dl>
                          ...
                          {this.state.data.telephone && <dt>WhatsApp group</dt>}
                          {this.state.data.telephone && (
                            <dd>
                              You have opted
