    ...
    return (
      <StaticQuery
        ...
        render={({ page, firstClaim, secondClaim }) => {
          ...
          return (
            <Layout title={'Membership renewal'} description={'Complete this form to renew your membership of the Manchester YMCA Harriers'} path={"/renew"} location={this.props.location}>
